...
.onAttach <-function(libname, pkgname) {
  ...
  packageStartupMessage("\\__ \\ | | | (_| \\__ \\ | | | | | (_| | |  | |")
  packageStartupMessage(glue::glue("|___/_| |_|\\__,_|___/_| |_| |_|\\__,_|_|",
                                   "  |_| - - {version}"))
  packageStartupMessage("")
  packageStartupMessage("Vérifiez les mises à jour à l'adresse suivante :")
  packageStartupMessage("https://github.com/pietrodito/sndsmart/blob/main/inst/extdata/version")
  packageStartupMessage("")
